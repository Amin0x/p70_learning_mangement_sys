...
class PaymentChannelsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\PaymentChannel::updateOrCreate(['id' => 14], ['title' => 'Adyen', 'class_name' => 'Adyen', 'status' => 'active', 'image' => '/assets/default/img/charge/paytu.png', 'settings' => '', 'created_at' => time()]);
