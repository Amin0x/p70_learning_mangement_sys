...
@section('content')
    ...
    @if(!empty($latestWebinars) and !$latestWebinars->isEmpty())
        <section class="home-sections home-sections-swiper container">
            <div class="d-flex justify-content-between ">
                <div>
                    <p class="sub-title primary right-line">{{trans('home.featured_classes_hint')}}</p>
                    <h2 class="section-title">{{ trans('home.featured_classes') }}</h2>
                </div>

                <a href="/classes" class="btn btn-primary">{{ trans('home.classes_all') }}</a>
            </div>
    ...
    @if(!empty($hasDiscountWebinars) and !$hasDiscountWebinars->isEmpty())
        <section class="home-sections container">
            <div class="d-flex justify-content-between">
                <div>
                <p class="sub-title primary right-line">{{ trans('home.discount_classes_hint') }}</p>
                    <h2 class="section-title">{{ trans('home.discount_classes') }}</h2>
                </div>

                <a href="/classes?discount=on" class="btn btn-primary">{{ trans('home.view_all') }}</a>
            </div>
            <div class="mt-10 position-relative">
    ...
    @if(!empty($instructors) and !$instructors->isEmpty())
        <section class="home-sections container">
            <div class="d-flex justify-content-between">
                <div>
                <p class="sub-title primary right-line">{{trans('home.instructors_hint') }}</p>
                    <h2 class="section-title">{{trans('home.instructors') }}</h2>
                </div>

                <a href="/instructors" class="btn btn-primary">{{trans('home.all_instructors') }}</a>
            </div>
    ...
    @if(!empty($blog) and !$blog->isEmpty())
        <section class="home-sections container">
            <div class="flex-end d-flex justify-content-between">
                <div>
                     <p class="sub-title primary right-line">{{ trans('home.blog_hint') }}</p>
                    <h2 class="section-title">{{ trans('home.blog') }}</h2>
                </div>

                <a href="/blog" class="btn btn-primary">{{ trans('home.all_blog') }}</a>
            </div>
