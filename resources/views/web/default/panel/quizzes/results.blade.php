        ...
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            ...
            <form action="/panel/quizzes/results" method="get" class="">
                <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    <label class="mb-0 mr-10 cursor-pointer font-14 text-gray font-weight-500" for="openQuizzesSwitch">{{ trans('quiz.show_only_open_results') }}</label>
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="open_results" class="custom-control-input" id="openQuizzesSwitch" @if(request()->get('open_results',null) == 'on') checked @endif>
                        <label class="custom-control-label" for="openQuizzesSwitch"></label>
                    </div>
                </div>
            </form>
        </div>
...
@push('scripts_bottom')
    ...
    <script>
        (function ($) {
            $('body').on('change', '#openQuizzesSwitch', function (e) {
                e.preventDefault();
